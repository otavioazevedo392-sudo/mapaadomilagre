    ...
    <section className="py-12 md:py-20 bg-background" data-testid="section-testimonials">
      <div className="container mx-auto max-w-7xl px-4 md:px-6">
        <div className="text-center space-y-4 mb-12">
          <h2 className="font-heading font-bold text-3xl md:text-4xl text-foreground" data-testid="text-testimonials-title">
        ...
        <div className="text-center mt-12">
          <Button 
            ...
            className="bg-accent-gold hover-elevate active-elevate-2 text-accent-gold-foreground font-semibold text-sm md:text-base w-full sm:w-auto px-4 md:px-6"
            data-testid="button-cta-testimonials"
          >
            <BookOpen className="w-4 h-4 md:w-5 md:h-5 mr-1.5 md:mr-2 flex-shrink-0" />
            <span className="leading-tight">QUERO FAZER PARTE DESSA TRANSFORMAÇÃO!</span>
          </Button>
        </div>
      </div>
    </section>
